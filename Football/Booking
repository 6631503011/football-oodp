...
public class Totofield extends Football {
	...
	public void queueFootball() {
		...
		Queue<String> Tqueue08AM = new LinkedList<>();
		Tqueue08AM.add("\nQueue 08.00-10.00 AM.");
		Tqueue08AM.add("\nQueue 08.00-10.00 AM.");
		Tqueue08AM.add("\nQueue 08.00-10.00 AM.");
		Tqueue08AM.add("\nQueue 08.00-10.00 AM.");
		
		Queue<String> Tqueue10AM = new LinkedList<>();
		Tqueue10AM.add("\nQueue 10.00-12.00 AM.");
		Tqueue10AM.add("\nQueue 10.00-12.00 AM.");
		Tqueue10AM.add("\nQueue 10.00-12.00 AM.");
		
		Queue<String> Tqueue13AM = new LinkedList<>();
		Tqueue13AM.add("\nQueue 13.00-15.00 AM.");
		Tqueue13AM.add("\nQueue 13.00-15.00 AM.");
		Tqueue13AM.add("\nQueue 13.00-15.00 AM.");
		Tqueue13AM.add("\nQueue 13.00-15.00 AM.");
		
		Queue<String> Tqueue15AM = new LinkedList<>();
		...
		if(timeInput == 1) {
			...
			if (names.contains(Name)) {
			    ...
			    try {
			        ...
			        myWriter.write("\n");
			        myWriter.write("\n");
			        myWriter.write("------------Toto Field Football------------");
			        myWriter.write("\n");
			        myWriter.write(Tqueue08AM.poll());
			        myWriter.write("\n");
		 ...
		 // Check if the list contain Name
	        if (names.contains(Name)) {
			    ...
			    try {
			        ...
			        myWriter.write("------------Toto Field Football------------");
			        myWriter.write("\n");
			        myWriter.write(Tqueue10AM.poll());
			        myWriter.write("\n");
		 ...
		 // Check if the list contain Name
	        if (names.contains(Name)) {
			    ...
			    try {
			        ...
			        myWriter.write("------------Toto Field Football------------");
			        myWriter.write("\n");
			        myWriter.write(Tqueue13AM.poll());
			        myWriter.write("\n");
			        myWriter.write("\nBooker: "+ Name + "   Totel person: " + numberPerson + " Person");
			        myWriter.write("\n");
			        myWriter.write("\nTotal cost: "+(Pricecalculation(numberPerson) - Pricecalculation(numberPerson)*0.1)+" Baht");
	        ...
	        if (names.contains(Name)) {
			    ...
			    try {
			        ...
			        myWriter.write("------------Toto Field Football------------");
			        myWriter.write("\n");
			        myWriter.write(Tqueue15AM.poll());
			        myWriter.write("\n");
			        myWriter.write("\nBooker: "+ Name + "   Totel person: " + numberPerson + " Person");
			        myWriter.write("\n");
			        myWriter.write("\nTotal cost: "+(Pricecalculation(numberPerson) - Pricecalculation(numberPerson)*0.1)+" Baht");
